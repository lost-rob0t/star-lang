;;;; Final declarative hygienic macro expander.
;;;; Extracted from prototype/macro-expander-prototype.lisp so macro semantics
;;;; are owned by starlang-compiler and can be exercised without prototype/.
