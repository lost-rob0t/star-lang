;;;; Final-owned resolver effect protocol for explicit specification-build I/O.
;;;;
;;;; Import/cache/digest policy belongs to the StarLang compiler/loader. Concrete
;;;; adapters perform only the requested effects so tests can substitute pure
;;;; functions without giving the compiler ambient filesystem/network authority.
